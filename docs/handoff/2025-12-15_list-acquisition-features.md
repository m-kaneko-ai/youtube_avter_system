...
## 8. 追加：秘密の重要機能（見落とされがち）

### 8.1 パフォーマンス学習システム（クローズドループ）
...
YouTube Analytics APIから視聴維持率データを取得し、離脱ポイントを特定。
次回の台本で改善ポイントを自動提案。

### 8.3 ショート→長尺→リスト ファネル
...
- ターゲットの「間違った常識」を取得
- 過去の成功フックを取得
- AHAコンセプト（差別化ポイント）を取得
→ これらを統合してパーソナライズされた台本を生成

---

**作成者**: Claude Code
**最終更新**: 2025-12-15 04:20 JST
